      ...
      <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
        ...
        <div className="space-y-6">
          <p className="text-lg leading-relaxed">
            Vous êtes dans l'âge d'or de la vie, une période pleine de liberté,
            de découvertes et de moments précieux à partager. Sur Senior Love,
            nous croyons que la beauté des relations ne fait que grandir avec le
            temps. Ici, les sexagénaires trouvent un espace chaleureux et
            accueillant, où l'amitié et l'amour prennent un nouveau souffle.
          </p>
          <p className="text-lg leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg">
                ...
                pour garantir des rencontres authentiques et en toute confiance.
              </p>
            </div>
