    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white shadow-lg rounded-lg p-8" style={{ marginTop: '4.5rem' }}>
        ...
        <div className="mb-8 p-4 bg-blue-50 rounded-lg">
          <p className="text-lg font-semibold">Protection de vos données personnelles</p>
          <p>Chez Senior Love, la protection de votre vie privée est notre priorité. Voici comment nous traitons vos données.</p>
        </div>

        <p className="text-sm text-gray-600 mb-6">Dernière mise à jour : 25.09.2024</p>

        <div className="prose max-w-none space-y-8">
          <section>
            <h2 className="text-xl font-semibold mb-4">1. Collecte des données</h2>
            <p>Nous collectons uniquement les données nécessaires à votre utilisation du service :</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Informations de profil (âge, situation, centres d'intérêt)</li>
          ...
          <section>
            ...
            <p>5.1 Vos données sont conservées tant que votre compte est actif.</p>
            <p>5.2 Après suppression du compte, vos données sont effacées sous 30 jours.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-4">6. Cookies et traceurs</h2>
          ...
          <section>
            ...
            <p>7.2 Vos données ne sont partagées qu'avec votre consentement explicite.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-4">8. Sécurité des seniors</h2>
